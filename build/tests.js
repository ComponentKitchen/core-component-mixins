...
var AttributeMarshalling = (function () {
  ...
  _createClass(AttributeMarshalling, [{
    ...
    value: function attributeChangedCallback(name, oldValue, newValue) {
      var base = this.AttributeMarshalling._super.attributeChangedCallback;
      if (base) {
        base.call(this);
      }
    ...
    value: function createdCallback() {
      ...
      var base = this.AttributeMarshalling._super.createdCallback;
      if (base) {
        base.call(this);
      }
...
var AutomaticNodeFinding = (function () {
  ...
  _createClass(AutomaticNodeFinding, [{
    ...
    value: function createdCallback() {
      ...
      var base = this.AutomaticNodeFinding._super.createdCallback;
      if (base) {
        base.call(this);
      }
      if (this.shadowRoot) {
...
var TemplateStamping = (function () {
  ...
  _createClass(TemplateStamping, [{
    ...
    value: function createdCallback() {
      // this.log("created");
      var base = this.TemplateStamping._super.createdCallback;
      if (base) {
        base();
      }
...
var MethodExtension = (function () {
  ...
  _createClass(MethodExtension, [{
    ...
    value: function method() {
      var superMethod = this.MethodExtension._super.method;
  ...
  test("extension can has multiple levels of inheritance", function () {
    var ExtensionSubclass = (function (_MethodExtension) {
      ...
      _createClass(ExtensionSubclass, [{
        key: 'method',
        value: function method() {
          var superMethod = this.ExtensionSubclass._super.method;
          if (superMethod) {
  ...
  test("extension property can reference superclass' property", function () {
    var PropertyExtension = (function () {
      ...
      _createClass(PropertyExtension, [{
        key: 'property',
        get: function get() {
          var superPrototype = this.PropertyExtension._super;
...
var CreatedExtension = (function () {
  ...
  _createClass(CreatedExtension, [{
    key: 'createdCallback',
    value: function createdCallback() {
      var base = this.CreatedExtension._super.createdCallback;
      if (base) {
        base.call(this);
      }
